...
Chinese fortune-telling (抽签/灵签) web app featuring eight oracle pages:
...
- **mazu.html** — 妈祖灵签 (Mazu Oracle): Dark blue/teal ocean theme, SVG 天后圣灯 (lantern) icon with shake animation, 60 fortune lots

All eight pages cross-link via fixed-position nav links (top-left and top-right corners).
